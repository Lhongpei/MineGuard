...
def test_audit_and_lifecycle() -> None:
    ...
    for token in (
        ...
        "code-page-independent ASCII",
        "resume JSON did not preserve the complete Unicode dataset",
        ...
        "[IO.Directory]::CreateDirectory($FullPath, $Acl)",
    ...
    for token in (
        ...
        "New-UnsignedWrapperProbeStage -Product agent",
        "unsigned-test classification transition",
    ...
    for token in (
        ...
        '"obj=" ("NT SERVICE\\" + $VirtualAccountProbeId)',
        "SCM did not persist the dedicated virtual service account",
        "Enterprise Agent SCM virtual-account transition passed",
